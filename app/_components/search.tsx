    ...
    <div className='w-full'>
      <form className="max-w-md mx-auto">
        ...
        <div className="relative">
          ...
          <button
            type="submit"
            className="absolute end-1.5 bottom-1.5 bg-blue-600 text-white hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium font-medium rounded-md text-sm px-4 py-2 focus:outline-none cursor-pointer"
          >
            Search
          </button>
        </div>
